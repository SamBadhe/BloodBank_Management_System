...
<head>
    ...
    <link rel="stylesheet" href="/miniproject_dbms/css/dashboard.css">
    <!-- font awesome script -->
...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark">
            ...
            <div class="collapse navbar-collapse nav_elements" id="navbarTogglerDemo02">
                ...
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="add_recipient_details.php">Recipient details</a>
                    </li>
                    <li class="nav-item">
    ...
    <!-- top part -->
    <div class="top">
        <h1 class="heading"><em><strong>XYZhospital</strong> </em> </h1>
        <img class="blood0" src="/miniproject_dbms/images/blood0.jpg" alt="background image">
    </div>
    ...
    <div class="bottom" id=aboutus>
        <h2>About us</h2>
        <p>
        <h4>This is DBMS Mini Project</h4>
        <br>
        <h5>Made by MITWPU students :</h5>
        ...
        PB 22 Neel Bafna
        <br>
        PB 24 Samihan Kulkarni
        <br>
        PB 31 Sujal Bhansali
        </p>
